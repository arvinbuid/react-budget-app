...
export const Intro = () => {
  return (
    <section className='h-auto lg:h-[80vh] px-4'>
      <div className='w-full h-full flex flex-col lg:flex-row justify-between items-center px-4 sm:px-6 lg:px-12 '>
        {/* left side - text content */}
        <div className='w-full lg:w-1/2 flex flex-col lg:items-start justify-center lg:pr-8'>
          <h1 className='text-3xl sm:text-5xl lg:text-6xl font-bold mb-4 text-center lg:text-left'>
          ...
          <div className='w-[95%] flex justify-center lg:justify-start'>
